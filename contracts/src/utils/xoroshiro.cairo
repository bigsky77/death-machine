...
@external
func reset{syscall_ptr : felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(seed: felt){
    let (contract_address) = XOROSHIRO_ADDR.read();
    IXoroshiro.reset_seed(contract_address=contract_address, seed=seed);
    return ();
}
